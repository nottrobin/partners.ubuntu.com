    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('partner', models.ForeignKey(to='webapp.Partner')),
            ],
        ),
        migrations.CreateModel(
            name='ServiceOffered',
        ...
        migrations.AddField(
            model_name='partner',
            name='partner_type',
            field=models.ManyToManyField(help_text=b'test', related_name='partners', null=True, to='webapp.PartnerType', blank=True),
        ),
        migrations.AddField(
            model_name='partner',
            name='programme',
            field=models.ManyToManyField(related_name='partners', null=True, to='webapp.Programme', blank=True),
        ),
        migrations.AddField(
            model_name='partner',
            name='service_offered',
            field=models.ManyToManyField(related_name='partners', null=True, to='webapp.ServiceOffered', blank=True),
        ),
        migrations.AddField(
            model_name='partner',
            name='technology',
            field=models.ManyToManyField(related_name='partners', null=True, to='webapp.Technology', blank=True),
        ),
        migrations.AddField(
            model_name='link',
            name='partner',
